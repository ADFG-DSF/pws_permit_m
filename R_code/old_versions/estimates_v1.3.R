...
file_3 <- str_c("shrimp_permits_", year, ".csv")
file_4 <- "shrimp_permits_"
...
# Read in the permit issued file to start tabulating N - total permits issued
permits <- read_csv(file_3)
